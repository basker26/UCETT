(function() {
    ...
    angular.module('app', [
        ...
        .constant("globalConfig", {
            ...
            editfinalinsertAPI:'http://localhost:4000/api/user/editfinalinsertAPI',
            getelementAPI:'http://localhost:4000/api/user/getelementAPI',
            editgetelementAPI:'http://localhost:4000/api/user/edit/getelementAPI',
            ...
            getsubjects:'http://localhost:4000/api/user/getsubjects',
            editsubject:'http://localhost:4000/api/user/editsubject',
